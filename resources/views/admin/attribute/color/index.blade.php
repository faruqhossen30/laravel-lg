@extends('admin.layouts.vertical', ['title' => 'Color   Table', 'sub_title' => 'Forms', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
                                    ...
                                    @foreach ($colors as $color)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                                ...
                                                <a href="{{route('category.edit', $color->id)}}" class="text-primary hover:text-sky-700">Edit</a>
