@extends('admin.layouts.vertical', ['title' => 'Role  Table', 'sub_title' => 'Roles', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
        ...
        <div class="card">
            <div class="card-header">
                <div class="flex justify-between items-center">
                    <h4 class="card-title">Admin Role and Permission</h4>
                    <div class="flex items-center gap-2">
                        <a href="{{ route('role.create') }}" class="btn-code">
                            <i class="mgc_add_circle_line text-lg"></i>
                            <span class="ms-2">Add Role</span>
                        </a>
                    </div>
                </div>
            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 text-sm text-gray-800 dark:text-gray-200">
                                                @foreach ($role->permissions as $perm)
                                                    <span
                                                        class="inline-flex items-center gap-1.5 py-1.5 px-3 my-1 rounded-full text-xs font-medium bg-green-500 text-white">
                                                        {{ $perm->name }}</span>
                                                @endforeach
                                            </td>
                                            </td>
