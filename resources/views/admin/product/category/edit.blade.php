@extends('admin.layouts.vertical', ['title' => 'Category Edit', 'sub_title' => 'Forms', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
		...
		<div class="p-6">
			...
			<form action="{{route('category.update', $category->id)}}" method="POST">
				...
				<div>
					...
					<input type="text" name="name" value="{{$category->name}}" id="simpleinput" class="form-input" placeholder="Category name">
				</div>
                <div class="py-2">
