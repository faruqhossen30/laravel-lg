@extends('admin.layouts.vertical', ['title' => 'Color Edit', 'sub_title' => 'Forms', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
		...
		<div class="p-6">
			...
			<form action="{{route('color.update', $colors ->id)}}" method="POST">
				...
				<div class="">
                    ...
                    <label for="simpleinput" class="text-gray-800 text-sm font-medium inline-block mb-2">Code</label>
