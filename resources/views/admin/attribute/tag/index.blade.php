@extends('admin.layouts.vertical', ['title' => 'Tag Table', 'sub_title' => 'Forms', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
            ...
            <div class="card-header">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center gap-2">
                        <a href="{{ route('tag.create') }}" class="btn-code">
                            <i class="mgc_add_circle_line text-lg"></i>
                            <span class="ms-2">Add Tag</span>
                        </a>
                    </div>
                </div>
            </div>
                                    ...
                                    @foreach ($tags as $tag)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                                ...
                                                <a href="{{route('tag.edit', $tag->id)}}" class="text-primary hover:text-sky-700">Edit</a>
