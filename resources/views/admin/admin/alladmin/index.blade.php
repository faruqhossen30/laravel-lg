@extends('admin.layouts.vertical', ['title' => 'Admin  Table', 'sub_title' => 'Forms', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
        ...
        <div class="card">
            <div class="card-header">
                <div class="flex justify-between items-center">
                    <h4 class="card-title">Header in Gray admin</h4>
                    <div class="flex items-center gap-2">
                        <a href="{{ route('admin.create') }}" class="btn-code">
                                    ...
                                    @foreach ($admins as $admin)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                                ...
                                                <a href="{{route('category.edit', $admin->id)}}" class="text-primary hover:text-sky-700">Edit</a>
