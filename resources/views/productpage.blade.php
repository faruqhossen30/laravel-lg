...
@section('content')
    ...
    <div class="container grid lg:grid-cols-4 gap-6 pt-4 pb-16 items-start relative">
        <!-- sidebar -->
        <div
            class="col-span-1 bg-white px-4 pt-4 pb-6 shadow rounded overflow-hidden absolute lg:static left-4 top-16 z-0 w-72 lg:w-full hidden md:block">
            <div class="divide-gray-200 divide-y space-y-5 relative">
                <!-- category filter -->
                <div class="relative">
                    <div class="lg:hidden text-gray-400 hover:text-brand text-lg absolute right-0 top-0 cursor-pointer">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" id="Bedroom" class="text-brand focus:ring-0 rounded-sm cursor-pointer">
                        ...
                        <!-- single category -->
                        <div class="flex items-center">
                            <input type="checkbox" id="Sofa" class="text-brand focus:ring-0 rounded-sm cursor-pointer">
                        ...
                        <!-- single category -->
                        <div class="flex items-center">
                            <input type="checkbox" id="Office" class="text-brand focus:ring-0 rounded-sm cursor-pointer">
                        ...
                        <!-- single category -->
                        <div class="flex items-center">
                            <input type="checkbox" id="Outdoor" class="text-brand focus:ring-0 rounded-sm cursor-pointer">
                ...
                <div class="pt-4">
                    ...
                    <div class="space-y-2">
                        <!-- single brand name -->
                        <div class="flex items-center">
                            <input type="checkbox" id="Dominik" class="text-brand focus:ring-0 rounded-sm cursor-pointer">
                        ...
                        <!-- single brand name -->
                        <div class="flex items-center">
                            <input type="checkbox" id="Karl" class="text-brand focus:ring-0 rounded-sm cursor-pointer">
                        ...
                        <!-- single brand name -->
                        <div class="flex items-center">
                            <input type="checkbox" id="Maxing" class="text-brand focus:ring-0 rounded-sm cursor-pointer">
                        ...
                        <!-- single brand name -->
                        <div class="flex items-center">
                            <input type="checkbox" id="Ernest" class="text-brand focus:ring-0 rounded-sm cursor-pointer">
