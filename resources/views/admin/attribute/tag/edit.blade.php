@extends('admin.layouts.vertical', ['title' => 'Tag Edit', 'sub_title' => 'Forms', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
	...
	<div class="card">
		...
		<div class="p-6">
			...
			<form action="{{route('tag.update', $tags ->id)}}" method="POST">
                ...
                @method('PUT')
				<div class="">
					<label for="simpleinput" class="text-gray-800 text-sm font-medium inline-block mb-2"> Tag Name</label>
					<input type="text" name="name" id="simpleinput" class="form-input" placeholder="Tag name">
